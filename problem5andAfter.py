...
def pro11():
    print('problem 11')
#     getGreatestProductOfAny4adjacentsInAnyDirectionInALine('08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08\n\
...
# 01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48')
    getGreatestProductOfAny4adjacentsInAnyDirectionInALine(
    '08 02 22\n\
    97 38 15\n\
    00 40 00\n')

def getGreatestProductOfAny4adjacentsInAnyDirectionInALine(stringGrid):
    # grid=
    theGreatestProduct=0
    numberOfAdjacents=2
    # def findTheGreatestProduct():

    # productOfTheBox=getTheProductOfTheBox(selected)
    # theGreatestProduct=theGreatestProduct if theGreatestProduct > productOfTheBox else productOfTheBox
    iterateGrid(getGrid(stringGrid),print,numberOfAdjacents)
...
def getGrid(stringGrid):
    return list(map(lambda stringLine:stringLine.split(),stringGrid.splitlines()))
